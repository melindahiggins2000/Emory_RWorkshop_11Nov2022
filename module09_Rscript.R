...
# LOAD HOSPITAL DATA BY STATE ====================
# data from https://healthdata.gov/Hospital/COVID-19-Reported-Patient-Impact-and-Hospital-Capa/g62h-syeh
# Dataset includes State Level Summaries
# about staff shortages, COVID cases, bed use
# by State for Jan and Feb 2022
